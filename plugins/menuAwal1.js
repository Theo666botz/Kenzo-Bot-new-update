...
let time = moment.tz('Asia/Jakarta').format('HH:mm:ss') 
    ...
    let ameliamd = "https://telegra.ph/file/7d3491af989a15965b857.jpg"
...
ketik .inv untuk melihat rpg lu ngav
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/4c1f2r',
    ...
    */
conn.sendButton(m.chat, '┍┈ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ', putra, ameliamd, [
                ['Owner', `${usedPrefix}owner`],
                ['Allmenu', `${usedPrefix}allmenu`]
            ], m)
...
handler.help = ['menu']
handler.tags = ['main']
handler.command = /^(menu|help|testing)$/i
