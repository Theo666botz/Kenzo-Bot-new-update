...
global.nameown = '༄ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ' // Nama Owner
global.wame = 'https://api.whatsapp.com/send?phone=+6283818409283'


/*============== STAFF ==============*/
global.owner = [
  ['6283818409283', '❦ ༄𝑍𝐼𝑅𝑂☆࿐ 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ'
global.namedoc = 'ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ' //Main Name Menu Document
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋 ┊ ᵀʰᵉᵒ⁶⁶⁶ᴮᵒᵗᶻ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
/*============== TEXT ==============*/
global.wait = pickRandom(["Sabar Sayang 98% 𝚠𝚊𝚒𝚝!!", "Wᴀɪᴛɪɴɢ", "「▰▰▰▱▱▱▱▱▱▱」ʟ ᴏ ᴀ ᴅ ɪ ɴ ɢ..."])
